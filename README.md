# Symptom & Medication Project

## 📌**Overview**

The Symptom & Medication Project helps users track their health by recording medications taken or symptoms experienced.
...
## 📌**Project Structure**
Symptom & Medication Project/
* ├── Symptom_& _Medication_Project.py
* ├── README.md
* ├── Report.pdf
* ├── /screenshots
* └── /recordings
